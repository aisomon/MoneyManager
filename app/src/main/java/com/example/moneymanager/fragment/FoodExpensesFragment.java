 ...
 */
public class FoodExpensesFragment extends Fragment {
    ...
    private void initView(View view) {
        ...
        int totalFoodExpenses = userRoomDatabase.userItemDaoAbs().getAmountByCategoryType(Constants.addFood,SharedPrefsUtils.getIntegerPreference(getContext(), Constant.USER_ID, 1));
        totalFood.setText(String.valueOf(totalFoodExpenses));

        userItemViewModel.loadAllUserItemByCategory(Constants.addFood,SharedPrefsUtils.getIntegerPreference(getContext(), Constant.USER_ID, 1))
