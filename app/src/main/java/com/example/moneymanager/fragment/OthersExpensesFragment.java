 ...
 */
public class OthersExpensesFragment extends Fragment {
    ...
    private void initView(View view) {
        ...
        int totalFoodExpenses = userRoomDatabase.userItemDaoAbs().getAmountByCategoryType(Constants.addOthers,SharedPrefsUtils.getIntegerPreference(getContext(), Constant.USER_ID, 1));
