 ...
 */
public class ShoppingExpensesFragment extends Fragment {
    ...
    public ShoppingExpensesFragment() {
    ...
    private void initView(View view) {
        ...
        int totalFoodExpenses = userRoomDatabase.userItemDaoAbs().getAmountByCategoryType(Constants.addShopping,SharedPrefsUtils.getIntegerPreference(getContext(), Constant.USER_ID, 1));
        totalFood.setText(String.valueOf(totalFoodExpenses));

        userItemViewModel.loadAllUserItemByCategory(Constants.addShopping,SharedPrefsUtils.getIntegerPreference(getContext(), Constant.USER_ID, 1))
