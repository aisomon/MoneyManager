 ...
 */
public class TransportExpensesFragment extends Fragment {
    ...
    public TransportExpensesFragment() {
    ...
    private void initView(View view) {
        ...
        int totalFoodExpenses = userRoomDatabase.userItemDaoAbs().getAmountByCategoryType(Constants.addTransport,SharedPrefsUtils.getIntegerPreference(getContext(), Constant.USER_ID, 1));
        totalFood.setText(String.valueOf(totalFoodExpenses));

        userItemViewModel.loadAllUserItemByCategory(Constants.addTransport,SharedPrefsUtils.getIntegerPreference(getContext(), Constant.USER_ID, 1))
